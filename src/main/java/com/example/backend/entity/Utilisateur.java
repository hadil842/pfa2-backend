...
public class Utilisateur {
    ...
    Utilisateur(String name, String password, String mail, Date date_naiss, String numer_tel, String nom_complet,
            String etat_civil, int sc) {
        this.nomaccess = name;
    ...
    public void setId(int ent) {
        this.idu = ent;
    }

    public void setAccessname(String nom) {
        this.nomaccess = nom;
    }
